$(document).ready(function () {
  ...
  function outerFunction(i) {
    // Modulus will allow us to use the i that is being incremented from the for loop to limit the return to one of the valid array index values ie: when the i = 84 then friends[84 % 5] = 4 which has a value of 'Ralph'
